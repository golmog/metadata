...
class ModuleJavCensored(PluginModuleBase):
    ...
    def __init__(self, P):
        ...
        self.db_default = {
            ...
            f"{self.name}_jav321_maintain_series_number_labels": "ABF, AP, GOOD, ID, NTRD, SAN, SORA, SW, TEN",
            ...
            f"{self.name}_javdb_maintain_series_number_labels": "ABF, AP, GOOD, ID, NTRD, SAN, SORA, SW, TEN",
            ...
            f"{self.name}_javbus_maintain_series_number_labels": "ABF, AP, GOOD, ID, NTRD, SAN, SORA, SW, TEN",
